...
Compare source and target aspect ratios before editing. If they differ, four goals cannot all be guaranteed simultaneously: exact target canvas, full source content, no distortion, and no added field. State the conflict and preserve the priorities the user actually named.
...
Blurred extension is not a universal fix. It can look like a foreign border around flat Amazon graphics. Inspect at least one light page and one dark or multi-band page before batch approval.
...
Every output has the exact requested dimensions, the product remains proportional, critical content is neither clipped nor redrawn, added fields match the source design, and representative light/dark pages have been visually inspected.
